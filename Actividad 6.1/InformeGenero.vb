...
Public Class InformeGenero
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Actividad_6._1.InformeGenero.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInformeGenero
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InformeGenero = New InformeGenero()
        rpt.Site = Me.Site
        Return rpt
    End Function
