...
Public Class InformeGrafico
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Actividad_6._1.InformeGrafico.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInformeGrafico
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InformeGrafico = New InformeGrafico()
        rpt.Site = Me.Site
        Return rpt
    End Function
