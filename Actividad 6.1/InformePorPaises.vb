...
Public Class InformePorPaises
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Actividad_6._1.InformePorPaises.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInformePorPaises
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InformePorPaises = New InformePorPaises()
        rpt.Site = Me.Site
        Return rpt
    End Function
